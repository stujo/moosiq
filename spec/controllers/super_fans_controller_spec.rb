...
describe SuperFansController do
  ...
  # SuperFansController. Be sure to keep this updated too.
  let(:valid_session) { {} }
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested super_fan" do
        super_fan = SuperFan.create! valid_attributes
        # Assuming there are no other super_fans in the database, this
    ...
    describe "with invalid params" do
      it "assigns the super_fan as @super_fan" do
        super_fan = SuperFan.create! valid_attributes
        # Trigger the behavior that occurs when invalid params are submitted
        SuperFan.any_instance.stub(:save).and_return(false)
